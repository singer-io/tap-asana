...
class TestTimeoutValuesPortfolios(unittest.TestCase):
    ...
    def test_integer_request_timeout_in_config(self):
        ...
        Context.config = {"start_date": "2017-01-01T00:00:00Z", "request_timeout": 100} # integer timeout in config
    ...
    def test_float_request_timeout_in_config(self):
        ...
        Context.config = {"start_date": "2017-01-01T00:00:00Z", "request_timeout": 100.5} # float timeout in config
    ...
    def test_string_request_timeout_in_config(self):
        ...
        Context.config = {"start_date": "2017-01-01T00:00:00Z", "request_timeout": "100"} # string format timeout in config
    ...
    def test_empty_string_request_timeout_in_config(self):
        ...
        Context.config = {"start_date": "2017-01-01T00:00:00Z", "request_timeout": ''} # empty string in config
    ...
    def test_zero_request_timeout_in_config(self):
        ...
        Context.config = {"start_date": "2017-01-01T00:00:00Z", "request_timeout": 0.0} # zero value in config

...
def get_items_for_portfolio(portfolio_gid):
  portfolio_items = list(Context.asana.client.portfolios.get_items_for_portfolio(portfolio_gid=portfolio_gid, timeout=Context.config.get('request_timeout', REQUEST_TIMEOUT)))
